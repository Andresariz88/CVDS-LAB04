...
public class GUI {
    ...
    public GUI(HangmanFactoryMethod factoryMethod) {
        ...
        this.schemeScore = factoryMethod.createOriginalScore();
    }

    @Inject
    // Use Guice constructor
    public GUI(Language language, HangmanDictionary dictionary, HangmanPanel hangmanPanel, GameScore schemeScore){
    ...
    private void setup(){
        ...
        GameModel gameModel = new GameModel(dictionary, schemeScore);
